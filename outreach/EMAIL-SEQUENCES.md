# Outreach Sequences — emails, DMs, follow-ups

Rules that make these work:
- **One named person.** Never `info@`.
- **The link is the pitch.** Get them to *play*, don't make them read.
- **Personalize line 1.** One specific, true reason you're emailing *them* (a game they
  just launched, a crash title in their catalogue, a program they run).
- **Short.** Under 120 words. One ask.
- **Warm the demo first** so it's not cold-starting when they click.
- Replace `[Aggregator]`, `[First]`, `[specific hook]`. Signature: **team@clutchstudios.co**.
...
Worth a 20-minute call to see if it fits your catalogue? Happy to drop you a sandbox.

Best,
[Your name] · Clutch Studios · team@clutchstudios.co

---

## B — Cold email, program-led (for Tier 1 studio programs)
**Subject:** new studio for [Program] — two live games, built to certify

Hi [First],

Is [Aggregator]'s [Ignite / Powered By / YGS Masters] studio program open to new content
partners? We're Clutch Studios — a new studio with **two live, provably-fair games on one
engine**: Ascent (crash) and Ascent Cross (step-multiplier climb).

Play both right now: **https://clutchstudios.co/play**

We're server-authoritative with deterministic replay and audit logs — built to pass
GLI-19 — and we're lining up distribution in parallel with certification. Your program
looks like the right home for that.
...
## C — Cold email, commercial-led (for BD/commercial contacts)
**Subject:** fresh crash content for your operators — revenue-share, one integration
...
Standard per-bet revenue share, founding-partner terms, no minimums. 20 minutes to see if
it's a fit?
...
Hi [First] — one reason this matters beyond "new crash game": every round is
**player-verifiable** (open /fairness on the demo). That's a trust/retention story your
operators can actually market with. Happy to show you how it works live — 15 minutes?

### F3 — +7 days (break-up)
**Subject:** last one from me
Hi [First] — I'll stop here so I'm not a nuisance. If crash/instant content isn't a
priority right now, no worries — the demo link stays live if it's ever useful:
**https://clutchstudios.co/play**. And if there's a better person to talk to, I'd
appreciate a name.
...
https://clutchstudios.co/play (Ascent = crash, "Ascent Cross" tab = a step-multiplier
climb; both on one integration). If it looks interesting, worth a quick call? Either way
I'd value your take.
...
- one integration, a growing catalogue — worth 20 min?
- the verifiable crash game (open the fairness tab)
